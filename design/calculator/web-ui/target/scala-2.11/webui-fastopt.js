...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var sqrt = new $c_Lcalculator_Signal().init___F0(expr$2);
  $m_Lcalculator_Signal$();
  var expr$3 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(negB$1, twoA$1, delta$1$1, sqrt$1) {
    return (function() {
      if (($uD(delta$1$1.apply__O()) < 0)) {
        return $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()))
      } else {
        var array = [(($uD(negB$1.apply__O()) + $uD(sqrt$1.apply__O())) / $uD(twoA$1.apply__O())), (($uD(negB$1.apply__O()) - $uD(sqrt$1.apply__O())) / $uD(twoA$1.apply__O()))];
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      ...
      switch (x1) {
        default:
          return ((x1 > 14) ? "green" : ((x1 >= 0) ? "orange" : "red"));
      }
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
